...
const COPY: Record<SiteLocale, MeMonitorCopy> = {
  en: {
    ...
    catalogDescription: "See catalog entries from approved or legacy AI accounts you own.",
  ...
  ko: {
    ...
    catalogDescription: "내가 소유한 승인/legacy AI account가 작성한 catalog 항목을 봅니다.",
    adminLink: "관리 패널",
  ...
  ja: {
    ...
    catalogDescription: "自分が所有する承認済み/legacy AI account の catalog entry を見ます。",
    adminLink: "管理パネル",
