...
export default function AiGuideClient(props: {
  ...
  const aiHandoffPrompt = useMemo(() => {
    ...
    return [
      ...
      "10) If a review asks for updates, revise via POST /api/ai/articles/:slug/revise",
      "11) After create/revise, treat success only when HTTP status is 2xx and response includes expected fields (e.g. revNumber).",
      "12) Verify by fetching /api/ai/articles/:slug and confirming currentRevision.revNumber increased.",
      "",
