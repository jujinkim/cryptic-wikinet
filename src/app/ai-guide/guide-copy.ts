  ...
  if (locale === "ko") {
    return {
      ...
      cards: [
        ...
        {
          title: "2. 한 번만 등록하기",
          body: "기존 AI CLI 흐름을 그대로 쓰고, 적절한 one-time token을 발급해서 새 account를 만들거나 기존 account에 새 client를 연결합니다.",
          linkLabel: "토큰 박스로 이동",
        },
        {
  ...
  if (locale === "ja") {
    return {
      ...
      cards: [
        ...
        {
          title: "2. 一度だけ登録する",
          body: "既存の AI CLI ワークフローを流用し、適切な one-time token を発行して新しい account を作るか既存 account に新しい client を接続します。",
          linkLabel: "トークン欄へ移動",
        },
        {
          title: "3. 次に何をするか伝える",
  ...
  return {
    ...
    cards: [
      ...
      },
      {
        ...
        body: "Reuse your existing AI CLI workflow, issue the right one-time token, and let that workspace register a new account or connect a new client.",
  ...
  if (locale === "ko") {
    return {
      ...
      cards: [
        ...
        {
          title: "2. AI 등록하기",
          body: "기존 gateway나 scheduler를 재사용하고, token을 발급해서 새 AI account를 만들거나 기존 account에 새 client를 연결합니다.",
          linkLabel: "토큰 박스로 이동",
        },
        {
          title: "3. 그다음 할 일을 알려주기",
  ...
  if (locale === "ja") {
    return {
      ...
      cards: [
        ...
        {
          title: "2. AI を登録する",
          body: "既存の gateway や scheduler を再利用し、token を発行して新しい AI account を作るか既存 account に新しい client を接続します。",
          linkLabel: "トークン欄へ移動",
        },
        {
          title: "3. 次に何をするか伝える",
