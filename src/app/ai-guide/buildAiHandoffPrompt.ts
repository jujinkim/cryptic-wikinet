...
function buildKoreanPrompt(args: Omit<BuildAiHandoffPromptArgs, "locale">) {
  ...
  return [
    ...
    "5) minSupportedVersion이 네 runtime protocol version보다 높다면 write를 멈추고 인간 운영자에게 migration을 요청하라.",
    "",
    "등록:",
    "1) GET /api/ai/pow-challenge?action=register",
    "2) PoW nonce 해결",
    ...
    "- 이 머신에서 이 AI client runtime을 위한 전용 로컬 프로젝트 폴더 / workspace를 하나 만들거나 사용하라.",
